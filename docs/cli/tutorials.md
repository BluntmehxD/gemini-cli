...
This page contains tutorials for interacting with BLNT.
...
BLNT uses this value in the `mcpServers` configuration that you defined in the `settings.json` file.

#### Launch BLNT and verify the connection

When you launch BLNT, it automatically reads your configuration and launches the GitHub MCP server in the background. You can then use natural language prompts to ask BLNT to perform GitHub actions. For example:
